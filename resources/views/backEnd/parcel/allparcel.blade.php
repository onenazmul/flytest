...
<section class="content">
                    ...
                    <div class="card custom-card">
                            ...
                            <form action="" class="filte-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <a download="parcel.xlsx" href="#" class="ml-2 btn btn-dark"
                                            onclick="return ExcellentExport.convert({ anchor: this, filename: 'parcel', format: 'xlsx'},[{name: 'Sheet Name Here 1', from: {table: 'datatable'}}]);">Export
                                            to CSV</a>
                                    </div>
                        ...
                        <div class="card-body" id="datatable">
                            ...
                            <table id="example" class="table table-bordered table-striped custom-table table-responsive"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($value->deliverymanId) {{@$deliverymanInfo->name}} <button
                                                class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#asignModal{{$value->id}}">Change Asign</button> @else
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{url('editor/deliveryman/asign')}}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <!-- Modal end -->
                                        <td>@if($value->agentId) {{@$agentInfo->name}}<button class="btn btn-dark btn-sm"
                                                data-toggle="modal" data-target="#agentModal{{$value->id}}">Change
                                                Asign</button> @else <button class="btn btn-primary" data-toggle="modal"
                                                data-target="#agentModal{{$value->id}}">Asign</button> @endif</td>
                                        <!-- Modal -->
                                        ...
                                        <td><?php $sptype=App\Parceltype::where('id',$value->status)->first(); ?><span
                                                class="btn btn-sm btn-danger">{{$sptype->title}}</span>
                           ...
                           ?> {{$value->partial_pay}}</td>
                                        ...
                                        <td>{{($value->cod-($value->deliveryCharge+$value->codCharge))-$partial}}
                                        </td>

                                        <td>
                                            <ul class="action_buttons">
                                                <li><a href="{{url('editor/parcel/edit/'.$value->id)}}"
                                                        class="edit_icon"><i class="fa fa-edit"></i></a></li>
                                                <li>
                        ...
                        <div class="col-md-6">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('F d, Y', strtotime($pn->updated_at))}}</td>
                                    <td>{{$pn->user}}</td>
                                    <td>{{$pn->note}}</td>
                                </tr>
                                @endforeach
    ...
    <li>
        <a class="edit_icon anchor" a href="{{url('editor/parcel/invoice/'.$value->id)}}" title="Invoice"><i
