            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card custom-card">
                      ...
                      <form action="{{url('editor/new/pickup')}}" method="get">
                        @csrf
                        <div class="row">
                          ...
                          <!-- col end -->
                          <div class="col-sm-2">
                          <select name="dman" id="" class="form-control">
                          <option value="all">All Deliveryman</option>
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tfoot>
                                    <th>Total</th>
                                    <th>Pick Drop ({{$total}})</th>
                                   <th>Total Charge ({{$tprice}})</th> 
                                    <th>Pending ({{$tpanding}})</th>
                                    <th>Accepted ({{$taccept}})</th>
                                    <th>Cancelled ({{$tcancel}})</th>
                                    <th>Delivered ({{$tdeliverd}})</th>
                                    </tfoot>
                            </table>
                        </div>
                        <!-- /.card-body -->
